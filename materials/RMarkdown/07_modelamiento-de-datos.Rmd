...
En la figura \@ref(fig:tableNorm1) hay un ejemplo de datos normalizados. En la figura,
...
```{r tableNorm1, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'Ejemplo de tablas con datos normalizados.'}
knitr::include_graphics("images/7.6_table-denorm.png")
```
