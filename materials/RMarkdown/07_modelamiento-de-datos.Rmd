...
knitr::include_graphics("images/7.7_table-denorm.png")
```
...
```{r modeloRE, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'Representación gráfica de una relación-entidad de dos tablas, incluyendo las claves con que se unen..'}
...
```{r sqlJoins, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'Las regiones en azul representan las filas que son incluidas en el resultado. Para un INNER join, las filas resultantes son todas las filas en A que tienen una pareja en B.'}
