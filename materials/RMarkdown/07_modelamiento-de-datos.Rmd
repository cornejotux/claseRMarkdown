...
```{r excelOrg1, echo=FALSE, out.width = '70%', fig.align = 'center', fig.cap = 'Planilla excel infernal.'}
knitr::include_graphics("images/7.1_excel-org-01.png")
```

## Tablas múltiples

```{r excelOrg2, echo=FALSE, out.width = '70%', fig.align = 'center', fig.cap = 'Múltiples tablas en una misma planilla. Otro caso de un excel infernal.'}
knitr::include_graphics("images/7.2_excel-org-02.png")
```

## Observaciones inconsistentes

```{r excelOrg3, echo=FALSE, out.width = '70%', fig.align = 'center', fig.cap = 'Observaciones diferentes en una misma fila de la tabla. Otro caso de un excel infernal.'}
knitr::include_graphics("images/7.3_excel-org-03.png")
```

## Inconsistencia en las variables

```{r excelOrg4, echo=FALSE, out.width = '70%', fig.align = 'center', fig.cap = 'Variables diferentes en la misma columna.'}
knitr::include_graphics("images/7.4_excel-org-04.png")
```

## Estadísticas y sumas al margen

```{r excelOrg5, echo=FALSE, out.width = '70%', fig.align = 'center', fig.cap = 'Valores que pueden ser calculados partir de los datos de la tabla. Otra mala práctica.'}
...
```{r tableDenorm1, echo=FALSE, out.width = '70%', fig.align = 'center', fig.cap = 'Valores obtenidos en diferentes entidades en la misma fila.'}
...
__Observaciones__. A better way to model data is to organize the observations about each type of entity in its own table.  This results in:
