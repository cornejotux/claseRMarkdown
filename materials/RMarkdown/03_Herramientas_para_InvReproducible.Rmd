...
Vamos a usar la versión de RStudio `r RStudio.Version()$version` o posterior, la que se puede descargar 
...
Si el resultado no dice `r RStudio.Version()$version` (o es una version anterior), por favor actualice
