...
significativo y util. Es tentador saltarse la escritura del mensaje asociado al 
...
entrege información que te permita sabe no solo que fue lo que hiciste, si no que
además se pueda entender el por qué. Ademas, los mensajes que se usan en commits
son en general más faciles de entender si usan una convención de verbos activos. 
...
autocontenido. La convención, sin embargo, es tratar de usar mensajes cortos, 
con una sentencia breve, seguido de una explicación más detallasda y racional 
para el cambio. Esto permite que el nivel de detallas seas leible en el registro
...
de los caloboradores que se tomaron el tiempo de describir el trabajo que 
realizaron.
