...
```{r githubSasapEdit, echo=FALSE, out.width = '70%', fig.align = 'center', fig.cap = 'Captura de pantalla con la interfase web de GitHub para la edición de documentos de texto.'}
knitr::include_graphics("images/6.10_sasap-test-edit.png")
```

```{r githubSasapCommit, echo=FALSE, out.width = '70%', fig.align = 'center', fig.cap = 'Captura de pantalla con la interfase web de GitHub para la confirmar de los cambios realizados al documento de texto (commit changes).'}
...
```{r githubSasapDisplayed, echo=FALSE, out.width = '70%', fig.align = 'center', fig.cap = 'Captura de pantalla con la interfase web los cambios corfimados (commits) y de la visualización de la página README.md.'}
