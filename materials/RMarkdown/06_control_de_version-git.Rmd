...
de cambios son los simples **nombres de archivos** (fig. \@ref(fig:finalDoc)). Teniendo esto en consideración, es lógico 
...
lo que se muestra en la figura \@ref(fig:figVersiones):
...
## Control de versiones y colaboracion usando Git and GitHub
