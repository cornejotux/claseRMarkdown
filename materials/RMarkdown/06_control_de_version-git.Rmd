...
versiones, pero esto **solo** ocurre si estamos trabajando en un _Proyecto de RStudio_
...
```{r rstudioPanelStatus, echo=FALSE, out.width = '100%', fig.align = 'center', fig.cap = 'Historial de los cambios realizados en el repositorio local.'}
