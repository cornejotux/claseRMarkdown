...
Ahora que ya entiende la estructura de una aplicación Shiny, es tiempo de construir la primera desde cero.
...
[Shiny Application Layout](https://shiny.rstudio.com/articles/layout-guide.html). En este libro usaremos `sidebarLayout`.
