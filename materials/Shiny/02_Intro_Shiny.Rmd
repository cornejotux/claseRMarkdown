...
Por defecto, las aplicaciones Shiny se muestran en un modo *normal*, como la imagen que se muestra en \@ref(fig:shinyBasicAppMod).
Sin embargo es posible ejecutar las aplicaciones en un panel junto al del código, para esto hay que definir “showcase mode”.
