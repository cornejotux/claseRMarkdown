...
![Figura 2.1: Interfase de Usuario (UI) limpia y sin contenido.](imagenes/2.1_Shiny_Clear.png)
...
![Figura 2.2: Interfase de Usuario (UI) limpia y sin contenido, con la barra lateral a la derecha, usando el argumento `position = "right"`.](imagenes/2.2_Shiny_ClearRight.png)
...
![Figura 2.3: Interfase de Usuario (UI) utilizando los 6 niveles de títulos (h1 a h6).](imagenes/2.3_Shiny_Titles.png)
...
![Figura 2.4: Interfase de Usuario (UI) donde se muestran ejemplos de como formatear texto.](imagenes/2.4_Shiny_FormatText.png)
...
```
![Figura 2.5: Interfase de Usuario (UI) con una imgaen local en directorio _www_ y una remota en un servidor web.](imagenes/2.5_Shiny_Img.png)
...
Cree una Shiny app utilizando lo que ha aprendido sobre el diseño de los paneles, HTML y funciones de imagen para crear una interfase de uruario atractiva. Vea cuando bien entiende estas funciones recreando la Shiny app que se presenta en la figura 2.6. Utilice los ejemplos con los que hemos trabajado durante el capítulo.

![Figura 2.6: Imagen de la Shiny app objetivo para la actividad de aprendizaje-](imagenes/2.6_Actividad.png)
